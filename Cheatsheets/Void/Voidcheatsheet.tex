...
\subsection{Configuration files}
	...
	\cm{/var/db/xbps/pkgdb-0.38.plist}{Default package database. Keeps track of installed packages and properties}
...
Flags that will most likely appear in many different commands with the same effect:
	...
	\cm{-R}{Forces repository mode, do not look into target}
...
\subsection{xbps-query}
	...
	\cm{-p, --property}{Matches packages with the given property, more than one can be specified by delimiting them with commas}
...
\subsection{Installation and Upgrade}
	...
	\cm{git clone}{Installs}
	\cm{./xbps-src binary-bootstrap}{Installs basic build enviroment}
