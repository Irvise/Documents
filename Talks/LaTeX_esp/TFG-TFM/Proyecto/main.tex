...
\documentclass[12pt, a4paper, twoside]{book} % General document definition. In order to have the text completely centered, do not use the twoside option; however, twoside is recommended for printing.
...
\usepackage{makeidx} % Index customization. This shouldn't be necessary
...
\usepackage[backend=biber,
	style=numeric,
	citestyle=numeric,
	sorting=none]{biblatex} % Citation configuration. We use biblatex, which is more
...
% This is an example on how to add a watermark {\thiswatermark{\centering\put(268,-802){\includegraphics[scale=1.5]{ComillasWatermark.pdf}}}}
