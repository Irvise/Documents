...
\begin{frame}[fragile, allowframebreaks]{Bibliografía, programas externos}
	...
	\hrulefill \\
	Nota, hay varios procesadores internos de bibliografía, nosotros usaremos el más flexible y sencillo:  \textrm{Bib\LaTeX.}
...
\begin{frame}[fragile]{Ecuaciones alineadas}
	Existen varios entornos, todos con sus peculiaridades, pero prácticamente idénticos. Los más conocidos son \texttt{split, aligned \& align}.  \texttt{align} numera cada salto de línea por defecto.
	\begin{columns}
		\begin{column}{0.5\textwidth}
			\begin{equation}
				\begin{split}
...
\begin{frame}[fragile]{Más flexibilidad en la escritura}
	\LaTeX\ aporta una forma elegante de incluir anotaciones en nuestras fórmulas
